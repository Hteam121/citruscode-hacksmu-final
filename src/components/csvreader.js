...
const CSVReader = ({ csvPath }) => { // Added csvPath as a prop
const [data, setData] = useState([]);
const [filter, setFilter] = useState({ 'Asset Type': '', 'Floor': '', 'Room': '' });
...
<th style={{ padding: '8px', textAlign: 'center' }}>Room</th>
...
<td style={{ padding: '8px', textAlign: 'center' }}>{item['Room']}</td>
